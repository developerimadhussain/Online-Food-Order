				...
				<div id="demo" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner">
						<div class="carousel-item active">
						 ...
						 <div class="food">
					<div class="container">
					 <h2 class="wow fadeInUp"><?php echo $_GET['food_cat'];?></h2>
						<div class="row">
				   ...
				   <?php
					         ...
					         require "database/Db_Connection.php";
											    ...
											    $cat=$_GET['food_cat'];
												$query="select *from food where category='$cat'";
						...
						while($row=mysqli_fetch_assoc($res)) {
					        ...
					        $location="category_food.php";
											
					        $str="fid={$id}&redirect={$location}&price={$price}&cat={$cat}";
