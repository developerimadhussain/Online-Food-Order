  <!DOCTYPE html>
	<html>
		...
		<section id="slide">
		 ...
		 <div class="registation" style="height:330px;">
    <div class="container">
	 <h2 class="wow fadeInUp"  style="color:white;"> Customer Login  </h2>
	 <div id="message1">
  ...
  <?php
											...
											if(isset($_GET['reg']))
											{
												echo '<font class="wow fadeInUp" data-wow-delay="0.4s" color="blue">Registration Successfully..</font>';
												echo '<br><br>';
											}
     ...
     <div class="container" >
                 ...
                 <form  action="index.php" method="POST" style="margin-left:350px;">
 ...
 <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="password" name="password" class="form-control" id="password" placeholder="Password">
				 ...
				 <button name="login" value="Login" style="background-color: blue; margin-right:90px;
                  border-color: darkmagenta;" class="btn btn-primary">Login</button>
				  <p  style="color:white;">Don't have account? <a  style="color:aqua;" href="registration.php">Register</a><p/>
             </form >
